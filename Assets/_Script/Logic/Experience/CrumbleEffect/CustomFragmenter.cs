...
public class CustomFragmenter : MonoBehaviour
{
    public static CustomFragmenter instance;
    ...
    /// <returns></returns>
    public void Fracture(GameObject sourceObject,
                                ...
                                string saveFolderPath = "")
    {
        ...
        while (fragments.Count < options.fragmentCount)
        {
            ...
            Vector3 normal = new Vector3(
                options.xAxis ? UnityEngine.Random.Range(-1f, 1f) : 0f,
                options.yAxis ? UnityEngine.Random.Range(-1f, 1f) : 0f,
                options.zAxis ? UnityEngine.Random.Range(-1f, 1f) : 0f);
    ...
    /// <param name="parent">The parent transform for the fragment objects</param>
    /// <returns></returns>
    public IEnumerator FractureAsync(GameObject sourceObject,
                                            FractureOptions options,
                                            GameObject fragmentTemplate,
                                            Transform parent,
                                            Action onCompletion)
    ...
    /// <param name="parent">The parent transform for the fragment objects</param>
    /// <returns></returns>
    public void Slice(GameObject sourceObject,
                             Vector3 sliceNormal,
                             Vector3 sliceOrigin,
    ...
    private void CreateFragment(FragmentData fragmentMeshData,
